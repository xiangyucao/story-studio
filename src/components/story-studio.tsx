    ...
    <main className="app-shell">
      ...
      <section className="workspace">
        ...
        {activeTab === "characters" && (
          ...
          <div className="outline-json-toolbar page-actions"><span className="data-toolbar-label">人物与关系</span><button className="text-button example-button" onClick={() => setJsonExampleKind("characters")}><FileText size={15} />JSON 示例</button><button className="secondary-button" onClick={() => characterImportInputRef.current?.click()}><Upload size={16} />导入 JSON</button><button className="secondary-button" onClick={exportCharactersToJson}><Download size={16} />导出 JSON</button></div>
        ...
        {activeTab === "world" && (
          ...
          <div className="outline-json-toolbar data-toolbar-groups"><div className="page-actions"><span className="data-toolbar-label">世界观</span><button className="text-button example-button" onClick={() => setJsonExampleKind("world")}><FileText size={15} />JSON 示例</button><button className="secondary-button" onClick={() => worldImportInputRef.current?.click()}><Upload size={16} />导入 JSON</button><button className="secondary-button" onClick={exportWorldToJson}><Download size={16} />导出 JSON</button></div><div className="page-actions"><span className="data-toolbar-label">时间线</span><button className="text-button example-button" onClick={() => setJsonExampleKind("timeline")}><FileText size={15} />JSON 示例</button><button className="secondary-button" onClick={() => timelineImportInputRef.current?.click()}><Upload size={16} />导入 JSON</button><button className="secondary-button" onClick={exportTimelineToJson}><Download size={16} />导出 JSON</button></div></div>
